...
namespace AdventureWorks.Mvc.Infrastructure
{
    public class DbExceptionAttribute : ExceptionFilterAttribute
    {
        private readonly IHostingEnvironment _hostingEnv;
        private ILoggerManager _logger;

        public DbExceptionAttribute(ILoggerManager logger, IHostingEnvironment env)
        {
            _logger = logger;
            _hostingEnv = env;
        }
